	...
	divContact.innerHTML = `
     <form id="contactForm">
          <div class="form-group">
               ...
               <input type="email" id="email" name="email" placeholder="JAYENDRAAWASTHIO6@GMAIL.COM" required>
          </div>
          ...
          <div class="form-group">
               ...
               <textarea id="content" name="content" placeholder="SOMETHING SOMETHING SOMETHING SOMETHING SOMETHING SOMETHING SOMETHING SOMETHING" required></textarea>
          </div>
